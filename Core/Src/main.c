...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
uint32_t signal1_values[SAMPLES];
uint32_t signal2_values[SAMPLES];
volatile float Raw_Sine_Wave ;
volatile float RC_Filter_Output ;
volatile float Raw_Sine_Wave_old ;
volatile float RC_Filter_Output_old ;
